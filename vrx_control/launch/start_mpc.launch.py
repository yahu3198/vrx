...
def launch(context, *args, **kwargs):
    ...
    # Include MPC Controller Launch File
    vrx_control_dir = get_package_share_directory("vrx_control")
    launch_processes.append(LogInfo(msg="✅ Launching MPC controller..."))
    ...
    launch_processes.append(LogInfo(msg="✅ MPC controller launch file included successfully!"))
...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('sim_mode', default_value='full',
                              description='Simulation mode: "full", "sim", "bridge". full: spawns robot and launch ros_gz bridges, sim: spawns robot only, bridge: launch ros_gz bridges only.'),
        ...
        DeclareLaunchArgument('robot', default_value='',
                              description='Name of robot to spawn if specified. This must match one of the robots in the config_file'),
