...
axs3[0].plot(left_thrust_angle, 'r-', label="Left Thrust Angle")
axs3[0].plot(right_thrust_angle, 'b-', label="Right Thrust Angle")
axs3[0].legend()
axs3[0].set_ylabel("Thrust Angle (rad)")
# axs3[0].set_xlim(5, 30)

axs3[1].plot(left_thrust_cmd, 'r-', label="Left Thrust Command")
axs3[1].plot(right_thrust_cmd, 'b-', label="Right Thrust Command")
axs3[1].legend()
